...
from llmkit.message import ImageURLPart, Message, TextPart, ToolCall
...
async def capture_request(
    ...
    match provider.__class__.__module__:
        case "llmkit.contrib.chat_provider.openai_legacy":
            ...
            async for _ in stream:
                pass
            return captured
        case "llmkit.contrib.chat_provider.anthropic":
