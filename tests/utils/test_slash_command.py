...
def test_slash_command_overwriting(test_registry: SlashCommandRegistry[Any]) -> None:
    ...
    @test_registry.command  # noqa: F811
    def test_cmd(app: object, args: str) -> None:  # noqa: F811
        """First version."""
        pass
