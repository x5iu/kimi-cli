try:
    ...
    raise ModuleNotFoundError(
        ...
        'Install with `pip install "llmkit[contrib]"`.'
    ) from exc
...
from llmkit.tooling import Tool as KosongTool
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        import llmkit
        from llmkit.tooling import CallableTool2, ToolOk
        ...
        result = await llmkit.step(chat, system_prompt, toolset, history)
