...
import pytest
from common import B64_PNG, COMMON_CASES, Case, capture_request, run_test_cases
...
from llmkit.message import ImageURLPart, Message, TextPart, ThinkPart
...
async def test_anthropic_message_conversion():
    ...
    results = await run_test_cases(None, provider, TEST_CASES, ("messages", "system", "tools"))
...
async def test_anthropic_opus_46_adaptive_thinking():
    ...
    beta_header = body.get("extra_headers", {}).get("anthropic-beta", "")
